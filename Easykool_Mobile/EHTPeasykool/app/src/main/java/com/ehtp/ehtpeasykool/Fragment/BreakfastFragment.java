...
import com.ehtp.ehtpeasykool.CartActivities.CartBreakfastActivity;
...
public class BreakfastFragment extends Fragment implements Adapter.ListItemClickListener {
    ...
    public BreakfastFragment(String pickadate) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       View view =inflater.inflate(R.layout.fragment_breakfast,container, false );
        ...
        mbase = FirebaseDatabase.getInstance().getReference("menu").child(pickadate).child("breakfast");
        ...
        cartbutoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), CartBreakfastActivity.class);
    ...
    public void onListItemClick(int position) {
        ...
        Intent intent=new Intent(getActivity(), foodBreakfastDetailsActivity.class);
        intent.putExtra("ArticleId", String.valueOf(position));
        intent.putExtra("pickadate",pickadate);
        intent.putExtra("repas","breakfast");
