...
import com.ehtp.ehtpeasykool.CartActivities.CartLunchActivity;
import com.ehtp.ehtpeasykool.FoodDetails.foodLunchDetailsActivity;
...
public class LunchFragment extends Fragment implements Adapter.ListItemClickListener {
    ...
    public LunchFragment(String pickadate) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mbase = FirebaseDatabase.getInstance().getReference("menu").child(pickadate).child("lunch");
        ...
        cartbutoon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(getContext(), CartLunchActivity.class);
    ...
    public void onListItemClick(int position) {
        ...
        Intent intent=new Intent(getActivity(), foodLunchDetailsActivity.class);
