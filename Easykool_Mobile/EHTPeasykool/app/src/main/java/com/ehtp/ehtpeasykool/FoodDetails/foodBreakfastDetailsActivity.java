...
public class foodBreakfastDetailsActivity extends AppCompatActivity implements RatingDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Articles=database.getReference("menu").child(pickadate).child("breakfast");
        ...
        btncart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               new Sqldatabase(getBaseContext()).addToBreakfastCart(new Order(
                       ArticleId,
                ...
                Toast.makeText(foodBreakfastDetailsActivity.this, "Added to cart ", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void showRating() {
        new AppRatingDialog.Builder()
                ...
                .create(foodBreakfastDetailsActivity.this)
                .show();
    }
        ...
        Rating.child(firebaseUser.getUid()).setValue(rateFood).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful())
                    Toast.makeText(foodBreakfastDetailsActivity.this, "you give a feedback,thanks! ", Toast.LENGTH_SHORT).show();
