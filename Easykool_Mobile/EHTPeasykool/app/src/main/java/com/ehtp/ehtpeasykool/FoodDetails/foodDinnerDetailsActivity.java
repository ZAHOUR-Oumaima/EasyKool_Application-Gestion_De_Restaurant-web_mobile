...
public class foodDinnerDetailsActivity extends AppCompatActivity  implements RatingDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Articles=database.getReference("menu").child(pickadate).child("dinner");
        ...
        btncart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new Sqldatabase(foodDinnerDetailsActivity.this).addToDinnerCart(new Order(
                        ArticleId,
                ...
                Toast.makeText(foodDinnerDetailsActivity.this, "Added to cart ", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void showRating() {
        new AppRatingDialog.Builder()
                ...
                .create(foodDinnerDetailsActivity.this)
                .show();
    }
        ...
        Rating.child(firebaseUser.getUid()).setValue(rateFood).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful())
                    Toast.makeText(foodDinnerDetailsActivity.this, "you give a feedback,thanks! ", Toast.LENGTH_SHORT).show();
