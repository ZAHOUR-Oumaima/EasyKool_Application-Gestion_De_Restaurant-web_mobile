...
public class CartDinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cart_dinner);
           ...
           // String date =simpleDateFormat.format(calendar.getTime());
            ...
            btn_reserver.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (points > 6)
                        Toast.makeText(CartDinnerActivity.this, "you have exceeded the point limit ", Toast.LENGTH_SHORT).show();
                    else if(points==0)
                        Toast.makeText(CartDinnerActivity.this, "there is nothing to reserve  ", Toast.LENGTH_SHORT).show();

                    else {

                        Request request = new Request(filerdOrders);
                        reservation.child(name).child("dinner").setValue(request);
                        Toast.makeText(CartDinnerActivity.this, "reservation successful", Toast.LENGTH_SHORT).show();
                        new Sqldatabase(getBaseContext()).cleanDinnerCart();
                        finish();
            ...
            btn_clean.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new Sqldatabase(CartDinnerActivity.this).cleanDinnerCart();
                    finish();
                }
            });
    ...
    private void LoadlistFood() {
        ...
        cart=new Sqldatabase(this).getDinnerCarts();
